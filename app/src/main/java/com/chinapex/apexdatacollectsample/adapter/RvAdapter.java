...
public class RvAdapter extends RecyclerView.Adapter<RvAdapter.RvHolder> implements View
    ...
    public RvHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rv_item, parent,
                false);
